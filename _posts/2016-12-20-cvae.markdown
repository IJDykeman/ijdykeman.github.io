...
![autoencoder diagram]({{ site.url }}/assets/ae_diagram.svg)
...
![encoder diagram]({{ site.url }}/assets/encoder_vae_diagram.svg)
...
![vae diagram]({{ site.url }}/assets/vae_diagram.svg)
...
![kl divergence diagram]({{ site.url }}/assets/kl_divergence_diagram.svg)
...
![cvae diagram]({{ site.url }}/assets/cvae_diagram.svg)
...
![cvae generation diagram]({{ site.url }}/assets/cvae_generation_diagram.svg)
